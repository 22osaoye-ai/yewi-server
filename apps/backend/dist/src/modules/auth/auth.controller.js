...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registrar nuevo usuario (Cliente o Profesional)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Refrescar token de acceso con rotación' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Nuevo par de tokens generado' }),
...
exports.AuthController = AuthController = __decorate([
    (0, swagger_1.ApiTags)('Auth (Autenticación & Seguridad)'),
