import { CategoryType, KycStatus, PackageTier, PrismaClient, UserRole } from '@prisma/client';
...
async function main() {
  ...
  // 2. Las 12 Categorías Oficiales de Zaragoza
  ...
  // 3. Crear Profesionales de Zaragoza con Códigos Postales Reales
  // Pro 1: Fontanero Centro (50001)
  const proCarlos = await prisma.user.create({
    data: {
      email: 'carlos.fontanero@yewi.es',
      passwordHash: defaultPasswordHash,
      roles: [UserRole.PROFESSIONAL, UserRole.CLIENT],
      isEmailVerified: true,
      profile: {
        create: {
          firstName: 'Carlos',
  ...
  // Pro 2: Electricista Actur (50018)
  ...
  // Pro 3: Reformas y Pintura Delicias (50010)
  ...
  // 4. Crear Gigs Reales de Servicios en Zaragoza
  // Gig 1: Fontanería Urgente
